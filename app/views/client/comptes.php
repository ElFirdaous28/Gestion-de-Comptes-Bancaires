            ...
            <div class="mt-6 bg-white rounded-lg shadow">
                <div class="p-6">
                    ...
                    <div class="mt-6 grid grid-cols-3 gap-4">
                        ...
                        <a href="/client/releveDuCompte/<?= htmlspecialchars($account["account_id"]) ?>" target="_blank"
                            class="flex items-center justify-center p-3 text-blue-600 border border-blue-600 rounded-lg hover:bg-purple-50 cursor-pointer">
